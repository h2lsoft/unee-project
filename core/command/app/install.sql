...
INSERT INTO `xcore_crontask` (`id`, `category`, `name`, `description`, `script_path`, `script_parameters`, `repetition_months`, `repetition_days`, `repetition_hours`, `repetition_minutes`, `email_report`, `email_report_subject`, `email_report_recipients`, `email_report_failure`, `status`, `locked`, `locked_date`, `last_error_message`, `last_execution_date_start`, `last_execution_date_end`, `priority`, `active`, `deleted`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`) VALUES (1, 'Core', 'Reset page and article status', '', '/core/cron/system/page.inc.php', '', '*', '*', '*', '0,5,10,15,20,25,30,35,40,45,50,55', 'no', '', '', 'no', 'finish', 'no', '2024-11-17 12:56:02', '', '2024-11-17 12:56:02', '2024-11-17 12:56:02', 0, 'yes', 'no', '2024-11-17 12:26:23', 'superadmin', '2024-11-17 12:56:02', '', NULL, NULL)


INSERT INTO `xcore_widget` (`xcore_plugin_id`, `name`, `method`, `autorefresh`, `autorefresh_seconds`, `position`, `active`, `deleted`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`) VALUES (24, 'Updater', '\\Core\\Live_UpdaterController::widgetRender()', 'no', 0, 1, 'yes', 'no', '2024-05-28 16:25:13', 'superadmin', '2024-05-28 16:25:13', '', NULL, NULL);
