...
INSERT INTO `xcore_widget` VALUES (1, 10, 'User bookmarks', '\\Core_Backend\\DashboardController::widgetBookmarkRender()', 'no', 0, 2, 'yes', 'no', '2024-05-28 16:25:13', 'superadmin', '2024-11-20 14:53:48', '', NULL, NULL);
...
INSERT INTO `xcore_plugin`
    (`id`, `xcore_menu_id`, `name`, `type`, `icon`, `route_prefix_name`, `actions`, `url`, `xcore_plugin_id`, `position`, `visible`, `versioning`, `active`, `deleted`, `created_at`, `created_by`)
VALUES
