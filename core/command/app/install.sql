...
INSERT INTO `xcore_mail_template` (`id`, `category`, `name`, `description`, `sender_en`, `subject_en`, `body_en`, `sender_fr`, `subject_fr`, `body_fr`, `deleted`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`) VALUES (1, 'core/auth', 'password-reset', '', '', 'Password reset', 'Hi,<br> <br> You have requested to reset your password,<br> in order to proceed please click on the link below :<br> <br> <a href="[[LINK]]">[[LINK]]</a>', '', 'Réinitialisation de votre mot de passe', 'Bonjour,<br> <br>  Vous avez demandé la réinitialisation de votre mot de passe,<br> afin de procéder merci de cliquer sur le lien ci-dessous :<br> <br> <a href="[[LINK]]">[[LINK]]</a>', 'no', NULL, NULL, NOW(), 'superadmin', NULL, NULL);
